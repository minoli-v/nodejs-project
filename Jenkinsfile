pipeline {
    ...
    stages {
        stage('Setup and Run') {
            steps {
                browserstack(credentialsId: '83338aa0-2e7b-41dc-9d11-a5352b5b037e', localConfig: [localOptions: '', localPath: 'https://www.browserstack.com/browserstack-local/BrowserStackLocal-darwin-x64.zip']){
                    sh 'ls'
